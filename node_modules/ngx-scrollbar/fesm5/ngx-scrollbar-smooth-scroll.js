...
import { InjectionToken, Inject, PLATFORM_ID, Optional, ɵɵdefineInjectable, ɵɵinject, Injectable, ElementRef, Directive, NgModule } from '@angular/core';
...
var SmoothScrollManager = /** @class */ (function () {
    ...
    SmoothScrollManager.ɵprov = ɵɵdefineInjectable({ factory: function SmoothScrollManager_Factory() { return new SmoothScrollManager(ɵɵinject(DOCUMENT), ɵɵinject(PLATFORM_ID), ɵɵinject(SMOOTH_SCROLL_OPTIONS, 8)); }, token: SmoothScrollManager, providedIn: "root" });
...
var SmoothScroll = /** @class */ (function () {
    ...
    SmoothScroll = __decorate([
        ...
        __metadata("design:paramtypes", [ElementRef, SmoothScrollManager])
    ], SmoothScroll);
    return SmoothScroll;
}());
