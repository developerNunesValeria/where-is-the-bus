(function (global, factory) {
    ...
    (global = global || self, factory(global['ngx-scrollbar'] = {}, global.ng.core, global.ng.common, global.ng.cdk.bidi, global.ng.cdk.portal, global.ng.cdk.platform, global['ngx-scrollbar']['smooth-scroll'], global.ng.cdk.coercion, global.rxjs, global.rxjs.operators));
}(this, (function (exports, core, common, bidi, portal, platform, smoothScroll, coercion, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ScrollbarManager = /** @class */ (function () {
        ...
        ScrollbarManager.ɵprov = core["ɵɵdefineInjectable"]({ factory: function ScrollbarManager_Factory() { return new ScrollbarManager(core["ɵɵinject"](NG_SCROLLBAR_OPTIONS, 8)); }, token: ScrollbarManager, providedIn: "root" });
        ScrollbarManager = __decorate([
            core.Injectable({ providedIn: 'root' }),
            __param(0, core.Optional()), __param(0, core.Inject(NG_SCROLLBAR_OPTIONS)),
    ...
    var NgScrollbar = /** @class */ (function () {
        ...
        NgScrollbar.prototype.ngOnInit = function () {
            ...
            this.zone.runOutsideAngular(function () {
                ...
                _this.scrolled = new rxjs.Observable(function (subscriber) {
                    return scrollStream.pipe(operators.takeUntil(_this.destroyed)).subscribe(subscriber);
                });
        ...
        __decorate([
            core.ViewChild(ScrollViewport, { static: true }),
            __metadata("design:type", ScrollViewport)
        ], NgScrollbar.prototype, "defaultViewPort", void 0);
        __decorate([
            core.ContentChild(ScrollViewport, { static: true }),
            __metadata("design:type", ScrollViewport)
    ...
    var NativeScrollbarSizeFactory = /** @class */ (function () {
        ...
        NativeScrollbarSizeFactory.ɵprov = core["ɵɵdefineInjectable"]({ factory: function NativeScrollbarSizeFactory_Factory() { return new NativeScrollbarSizeFactory(core["ɵɵinject"](common.DOCUMENT), core["ɵɵinject"](ScrollbarManager), core["ɵɵinject"](platform.Platform)); }, token: NativeScrollbarSizeFactory, providedIn: "root" });
    ...
    var HideNativeScrollbar = /** @class */ (function () {
        function HideNativeScrollbar(el, renderer, hideNativeScrollbar) {
            ...
            this._subscriber = hideNativeScrollbar.scrollbarSize.subscribe(function (size) {
                _this.renderer.setStyle(el.nativeElement, '--native-scrollbar-size', "-" + size + "px", core.RendererStyleFlags2.DashCase);
            });
        }
    ...
    var NgAttr = /** @class */ (function () {
        ...
        NgAttr = __decorate([
            core.Directive({ selector: '[ngAttr]' }),
            __metadata("design:paramtypes", [core.ElementRef])
        ], NgAttr);
        return NgAttr;
    }());
    ...
    var ResizeObserverFactory = /** @class */ (function () {
        function ResizeObserverFactory(document, platform) {
            ...
            if (platform.isBrowser) {
                var resizeObserverApi = document.defaultView.ResizeObserver
                    ...
                    : rxjs.from(import('@juggle/resize-observer')).pipe(operators.map(function (module) { return module.ResizeObserver; }), operators.catchError(function (e) {
        ...
        ResizeObserverFactory.ɵprov = core["ɵɵdefineInjectable"]({ factory: function ResizeObserverFactory_Factory() { return new ResizeObserverFactory(core["ɵɵinject"](common.DOCUMENT), core["ɵɵinject"](platform.Platform)); }, token: ResizeObserverFactory, providedIn: "root" });
        ResizeObserverFactory = __decorate([
            core.Injectable({ providedIn: 'root' }),
            __param(0, core.Inject(common.DOCUMENT)),
            __metadata("design:paramtypes", [Object, platform.Platform])
    ...
    var ResizeSensor = /** @class */ (function () {
        ...
        ResizeSensor.prototype._subscribe = function () {
            ...
            if (this.platform.isBrowser) {
                this.zone.runOutsideAngular(function () {
                    _this._subscription = _this.resizeObserverFactory.resizeObserverLoader.pipe(operators.switchMap(function (moduleObservable) { return moduleObservable; }), operators.switchMap(function (ResizeObserver) {
                        if (ResizeObserver) {
        ...
        __decorate([
            core.Input('sensorDebounce'),
            __metadata("design:type", Number),
            __metadata("design:paramtypes", [Number])
        ], ResizeSensor.prototype, "debounce", null);
        __decorate([
            core.Input('sensorDisabled'),
            __metadata("design:type", Object),
            __metadata("design:paramtypes", [Object])
        ...
        ResizeSensor = __decorate([
            core.Directive({ selector: '[resizeSensor]' }),
    ...
    var TrackAdapter = /** @class */ (function () {
        ...
        Object.defineProperty(TrackAdapter.prototype, "hovered", {
            ...
            get: function () {
                var mouseEnter = rxjs.fromEvent(this.trackElement, 'mouseenter', { passive: true }).pipe(stopPropagation(), operators.map(function () { return true; }));
                var mouseLeave = rxjs.fromEvent(this.trackElement, 'mouseleave', { passive: true }).pipe(stopPropagation(), operators.map(function () { return false; }));
        ...
        TrackAdapter.prototype.onTrackClicked = function (e, thumbSize, scrollSize) {
            ...
            operators.tap(function (value) {
                _this.cmp.scrollTo(__assign(__assign({}, _this.mapToScrollToOption(value)), { duration: coercion.coerceNumberProperty(_this.cmp.trackClickScrollDuration) }));
            }));
        };
        return TrackAdapter;
    }());
    ...
    var ThumbXDirective = /** @class */ (function (_super) {
        ...
        ThumbXDirective = __decorate([
            core.Directive({ selector: '[scrollbarThumbX]' }),
            __param(2, core.Inject(common.DOCUMENT)),
            __metadata("design:paramtypes", [NgScrollbar,
                core.ElementRef, Object, bidi.Directionality])
        ], ThumbXDirective);
    ...
    var ThumbYDirective = /** @class */ (function (_super) {
        ...
        ThumbYDirective = __decorate([
            core.Directive({ selector: '[scrollbarThumbY]' }),
            __param(2, core.Inject(common.DOCUMENT)),
            __metadata("design:paramtypes", [NgScrollbar,
    ...
    var TrackXDirective = /** @class */ (function (_super) {
        ...
        TrackXDirective = __decorate([
            core.Directive({ selector: '[scrollbarTrackX]' }),
            __param(2, core.Inject(common.DOCUMENT)),
            __metadata("design:paramtypes", [NgScrollbar, core.ElementRef, Object])
        ], TrackXDirective);
    ...
    var TrackYDirective = /** @class */ (function (_super) {
        ...
        TrackYDirective = __decorate([
            core.Directive({ selector: '[scrollbarTrackY]' }),
            __param(2, core.Inject(common.DOCUMENT)),
            __metadata("design:paramtypes", [NgScrollbar, core.ElementRef, Object])
        ], TrackYDirective);
    ...
    var Scrollbar = /** @class */ (function () {
        ...
        Scrollbar.prototype.activatePointerEvents = function () {
            ...
            if (this.cmp.pointerEventsMethod === 'viewport') {
                ...
                operators.map(function (e) { return isWithinBounds(e, _this.track.clientRect); }), operators.distinctUntilChanged(), 
        ...
        Scrollbar.prototype.ngOnInit = function () {
            ...
            this.zone.runOutsideAngular(function () {
                ...
                var updated = _this.cmp.updated.pipe(operators.tap(function () { return _this.onUpdated(); }));
                // Update scrollbar thumb when viewport is scrolled and when scrollbar component is updated
                rxjs.merge(_this.cmp.scrolled, updated).pipe(operators.tap(function () { return _this.thumb.update(); }), operators.takeUntil(_this.destroyed)).subscribe();
                // Initialize scrollbar
                rxjs.asyncScheduler.schedule(function () { return _this.thumb.update(); }, 100);
            });
        };
    ...
    var ScrollbarY = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild(TrackYDirective, { static: true }),
            __metadata("design:type", TrackYDirective)
        ], ScrollbarY.prototype, "track", void 0);
        __decorate([
            core.ViewChild(ThumbYDirective, { static: true }),
        ...
        ScrollbarY = __decorate([
            ...
            __param(2, core.Inject(common.DOCUMENT)),
            __metadata("design:paramtypes", [NgScrollbar, platform.Platform, Object, core.NgZone])
        ], ScrollbarY);
        return ScrollbarY;
    }(Scrollbar));
    var ScrollbarX = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild(TrackXDirective, { static: true }),
            __metadata("design:type", TrackXDirective)
        ], ScrollbarX.prototype, "track", void 0);
        __decorate([
            core.ViewChild(ThumbXDirective, { static: true }),
        ...
        ScrollbarX = __decorate([
            ...
            __metadata("design:paramtypes", [core.ElementRef,
                NgScrollbar,
                platform.Platform, Object, core.NgZone])
        ], ScrollbarX);
        return ScrollbarX;
    }(Scrollbar));
